...
privileged aspect Agent_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Agent.fieldNames4OrderClauseFilter = java.util.Arrays.asList("serialVersionUID", "parentEnfants", "nomatr", "nomPatronymique", "nomMarital", "nomUsage", "prenomUsage", "prenom", "titre", "sexe", "dateNaissance", "situationFamiliale", "numCafat", "numRuamm", "numMutuelle", "numCre", "numIrcafex", "numClr", "codeCommuneNaissFr", "codeCommuneNaissEt", "codePaysNaissEt", "intituleCompte", "rib", "numCompte", "codeBanque", "codeGuichet", "lieuNaissance", "banque", "voie", "rueNonNoumea", "bP", "adresseComplementaire", "numRue", "bisTer", "codeCommuneVilleDom", "codeCommuneVilleBP", "codePostalVilleDom", "codePostalVilleBP", "rue", "position");

...
privileged aspect Spfili_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Spfili.fieldNames4OrderClauseFilter = java.util.Arrays.asList("cdfili", "libelleFili");
    ...
    public static List<Spfili> Spfili.findAllSpfilis(String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Spfili o";
        ...
        return entityManager().createQuery(jpaQuery, Spfili.class).getResultList();
    }
    ...
    public static List<Spfili> Spfili.findSpfiliEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Spfili o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
        ...
        return entityManager().createQuery(jpaQuery, Spfili.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }

...
privileged aspect Siserv_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Siserv.fieldNames4OrderClauseFilter = java.util.Arrays.asList("siservSrv", "servi", "liServ", "codeActif", "sigle", "parentSigle", "division", "direction", "directionSigle", "section");

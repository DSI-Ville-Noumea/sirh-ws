...
privileged aspect Eae_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Eae.fieldNames4OrderClauseFilter = java.util.Arrays.asList("eaeCampagne", "idAgentDelegataire", "eaeEvaluateurs", "eaeFichePoste", "eaeEvalue", "eaeEvaluation", "agentEvalue", "agentDelegataire");

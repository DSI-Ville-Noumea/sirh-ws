...
public class EaeController {
	...
	public ResponseEntity<String> listDelegataireByAgent(@RequestParam(value = "idAgent", required = true) Long idAgent)
		...
		NoeudDto serviceAgent = agentSrv.getServiceAgent(ag.getIdAgent(), null);
		if (serviceAgent == null)
			return new ResponseEntity<String>(HttpStatus.NO_CONTENT);

		List<Agent> listAgentService = agentSrv.listAgentServiceSansAgent(serviceAgent.getIdService(), ag.getIdAgent());

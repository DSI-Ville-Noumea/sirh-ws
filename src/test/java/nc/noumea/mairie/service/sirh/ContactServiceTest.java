...
public class ContactServiceTest {
	...
	@Test
	public void getContactsDiffusableAgent_returnEmptyList() {
		// Given
		List<Contact> listeContact = new ArrayList<Contact>();
		...
		// When
		List<Contact> result = contactService.getContactsDiffusableAgent((long) 9005138);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void getContactsDiffusableAgent_returnListContact() {
		// Given
		List<Contact> listeContact = new ArrayList<Contact>();
		Contact ag1 = new Contact();
		ag1.setIdAgent(9005138);

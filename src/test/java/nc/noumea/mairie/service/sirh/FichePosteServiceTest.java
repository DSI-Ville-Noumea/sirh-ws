...
public class FichePosteServiceTest {
	...
	public void rechercheFichesPosteParent_unParent() {
		...
		IFichePosteRepository fichePosteDao = Mockito.mock(IFichePosteRepository.class);
		Mockito.when(fichePosteDao.getListFichePosteByIdServiceADSAndStatutFDPWithJointurePourOptimisation(Arrays.asList(idEntite), Arrays.asList(EnumStatutFichePoste.VALIDEE.getStatut(), EnumStatutFichePoste.EN_CREATION.getStatut(),
	...
	public void getTreeFichesPosteByIdEntite_3Niveaux() {
		...
		ficheService.construitArbreFichePostes();
		List<FichePosteTreeNodeDto> result = ficheService.getTreeFichesPosteByIdEntite(idEntite);
		...
		// 3e niveau
		assertEquals(result.get(0).getFichePostesEnfant().get(1).getFichePostesEnfant().get(1).getIdFichePoste().intValue(), 4);
		assertEquals(result.get(0).getFichePostesEnfant().get(0).getFichePostesEnfant().get(1).getIdFichePoste().intValue(), 5);
		assertEquals(result.get(0).getFichePostesEnfant().get(1).getFichePostesEnfant().get(0).getIdFichePoste().intValue(), 6);
		assertEquals(result.get(0).getFichePostesEnfant().get(0).getFichePostesEnfant().get(0).getIdFichePoste().intValue(), 7);
	}
